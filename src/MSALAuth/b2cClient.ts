...
export class B2CClient {
  ...
  private policyUrls: B2CPolicies; // readonly
  ...
  constructor(b2cConfig: B2CConfiguration) {
    console.warn('constructor(b2cConfig - ', b2cConfig);
  ...
  /** initClient a B2CClient object
   * @param b2cConfig The configuration object for the B2CClient
   */
  public initClient(b2cConfig: B2CConfiguration) {
    console.warn('constructor(b2cConfig - ', b2cConfig);
  ...
  public async init() {
    console.warn('client init - ', global._clientId, this.pca);
    
    await this.pca.init();
    console.warn('client after init - ', this.pca);
    return this;
  }
