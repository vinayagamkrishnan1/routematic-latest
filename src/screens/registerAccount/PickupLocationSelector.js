...
class PickupLocationSelector extends Component {
        ...
        return (
            <SafeAreaView style={{flex: 1, backgroundColor: colors.WHITE}}>
                <View style={styles.container}>
                    ...
                    />
                    <RenderPickerHeader name={setupMandatoryFields.pickupLocationID} onGoBack={this.onGoBack}/>
                            ...
                            return (
                                <React.Fragment>
                                    <TouchableDebounce
                                        ...
                                        onPress={() => {
                                            this.props.route.params.setPickup(item);
                                            this.props.navigation.goBack();
                                        }}
                                    >
                                        <Text
