...
class OfficeSelector extends Component {
    ...
    componentDidMount() {
        ...
        let offices = this.props.route.params.hasOwnProperty("offices")?this.props.route.params.offices:[];
    ...
    render() {
        ...
        let OfficesArray = this.state.offices.length > 0 ? this.state.offices : this.props.adhocStore.Offices;
        let offices = OfficesArray.filter(word =>
        ...
        return (
            <SafeAreaView style={{flex: 1, backgroundColor: colors.WHITE}}>
                <View style={styles.container}>
                    ...
                    />
                    <RenderPickerHeader name={"Offices"} onGoBack={this.onGoBack}/>
                    ...
                    <FlatList
                        ...
                        renderItem={({item, index}) => {
                            let name= item.officeLocationName;
                            ...
                            return (
                                <React.Fragment>
                                    <TouchableDebounce
                                        ...
                                        onPress={() => {
                                            this.props.route.params.onOfficeSelected(item);
                                            this.props.navigation.goBack();
                                        }}
                                    >
                                        <Text
