...
@inject("adhocStore")
@observer
class TDCostCenterSelector extends Component {
    ...
    componentDidMount() {
        ...
        let costCenters = this.props.route.params.hasOwnProperty("costCenters")?this.props.route.params.costCenters:[];
        this.setState({selectedItem,costCenters});
        setTimeout(() => {
    ...
    render() {
        ...
        let CostCentersArray = this.state.costCenters.length > 0 ? this.state.costCenters : this.props.adhocStore.CostCenters;
        
        let costCenters = CostCentersArray.filter(word =>
        ...
        return (
            <SafeAreaView style={{flex: 1, backgroundColor: colors.WHITE}}>
                <View style={styles.container}>
                    ...
                    />
                    <RenderPickerHeader name={"Cost Centers"} onGoBack={this.onGoBack}/>
                                    ...
                                    <TouchableDebounce
                                        ...
                                        onPress={() => {
                                            if(this.state.costCenters.length>0){
                                                ...
                                                this.props.adhocStore.setTDCostCenter(item);
                                                this.props.navigation.goBack();
                                            }
                                        }}
                                    >
...
export default TDCostCenterSelector;
