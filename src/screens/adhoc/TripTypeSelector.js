...
class TripTypeSelector extends Component {
    ...
    render() {
        ...
        let tripTypes = this.props.adhocStore.ProgramsDetails.Types.filter(word =>
        ...
        return (
            <SafeAreaView style={{flex: 1, backgroundColor: colors.WHITE}}>
                <View style={styles.container}>
                    ...
                    />
                    <RenderPickerHeader name={"Trip Type"} onGoBack={this.onGoBack}/>
                            ...
                            return (
                                <React.Fragment>
                                    <TouchableDebounce
                                        ...
                                        onPress={() => {
                                            this.props.adhocStore.setTripType(item.Name);
                                            this.props.navigation.goBack();
                                        }}
                                    >
                                        <Text
