...
@inject("adhocStore")
@observer
class VisitorSelector extends Component {
    ...
    componentDidMount() {
        ...
        let visitors = this.props.route.params.hasOwnProperty("visitors")?this.props.route.params.visitors:[];
        this.setState({selectedItem,visitors});
        setTimeout(() => {
    ...
    render() {
        ...
        let VisitorsArray = this.state.visitors.length > 0 ? this.state.visitors : this.props.adhocStore.Visitors;
        let visitors = VisitorsArray.filter(word =>
        ...
        return (
            <SafeAreaView style={{flex: 1, backgroundColor: colors.WHITE}}>
                <View style={styles.container}>
                    ...
                    />
                    <RenderPickerHeader name={"Visitors"} onGoBack={this.onGoBack}/>
                                    ...
                                    <TouchableDebounce
                                        ...
                                        onPress={() => {
                                            if(this.state.visitors.length>0){
                                                this.props.route.params.onVisitorSelected(item);
                                                this.props.navigation.goBack();
                                            }else{
                                                this.props.adhocStore.setVisitor(item.Name);
                                                this.props.navigation.goBack();
                                            }
                                        }}
                                    >
