...
@observer
class FixedRouteOfficePicker extends Component {
    ...
    render() {
        ...
        let offices = this.props.fixedRouteStore.Offices?.filter(word =>
                                    ...
                                    <TouchableDebounce
                                        ...
                                        onPress={() => {
                                            if (this.state.type === roster.login) {
                                                this.props.fixedRouteStore.updateLoginOffice(item);
                                            } else {
                                                this.props.fixedRouteStore.updateLogOutOffice(item);
                                            }
                                            this.props.navigation.goBack();
                                        }}
                                    >
...
export default FixedRouteOfficePicker;
