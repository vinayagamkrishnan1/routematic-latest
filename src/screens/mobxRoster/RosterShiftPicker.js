...
@inject("rosterStore")
@observer
class RosterShiftPicker extends Component {
                                        ...
                                        onPress={() => {
                                            if(this.props.route.params.from===true) {
                                                if (type === roster.login) {
                                                    this.props.rosterStore.setLoginShifts(item);
                                                }else{
                                                    this.props.rosterStore.setLogoutShifts(item);
                                                }
                                            }else {
                                                if (type === roster.login) {
                                                    this.props.rosterStore.updateLoginShiftTime(item);
                                                } else {
                                                    this.props.rosterStore.updateLogOutShiftTime(item);
                                                }
                                            }
                                            this.props.navigation.goBack();
                                        }}
...
export default RosterShiftPicker;
