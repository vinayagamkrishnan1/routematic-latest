...
#ifndef PARKZEUS_SWIFT_H
#define PARKZEUS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ParkZeus",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8ParkZeus12PZController")
@interface PZController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSCoder;

SWIFT_CLASS("_TtC8ParkZeus11PZTextField")
@interface PZTextField : UITextField
...
@interface UINavigationController (SWIFT_EXTENSION(ParkZeus)) <UINavigationControllerDelegate>
@end
